...
Partial Class frmSettings_DeleteItem
    ...
    Private Sub InitializeComponent()
        ...
        btnDelete.Location = New Point(298, 178)
        ...
        Label1.Name = "Label1"
        Label1.Size = New Size(243, 16)
        Label1.TabIndex = 0
        Label1.Text = "Delete shop item and equipment"
        ' 
        ' frmSettings_DeleteItem
        ' 
