...
Partial Class frmNav_MainDashboard
    ...
    Private Sub InitializeComponent()
        ...
        ' MenuStrip1
        ' 
        MenuStrip1.Items.AddRange(New ToolStripItem() {StaffToolStripMenuItem, InventoryToolStripMenuItem, SalesToolStripMenuItem, LoansSavingsToolStripMenuItem, AccountsToolStripMenuItem, SettingsToolStripMenuItem})
        ...
        ' 
        StaffToolStripMenuItem.DropDownItems.AddRange(New ToolStripItem() {StaffLunchToolStripMenuItem, StaffAttendanceToolStripMenuItem, ReportsToolStripMenuItem, AddStaffToolStripMenuItem})
        StaffToolStripMenuItem.Font = New Font("Verdana", 9.75F)
        ...
        StaffLunchToolStripMenuItem.Font = New Font("Verdana", 9.75F)
        StaffLunchToolStripMenuItem.Name = "StaffLunchToolStripMenuItem"
        ...
        RecordAttendanceToolStripMenuItem.Size = New Size(237, 22)
        RecordAttendanceToolStripMenuItem.Text = "Mark Attendance"
        ' 
        ' ViewAttendanceRecordToolStripMenuItem
        ' 
        ViewAttendanceRecordToolStripMenuItem.Name = "ViewAttendanceRecordToolStripMenuItem"
        ...
        ' 
        ViewActiveLoansToolStripMenuItem.Name = "ViewActiveLoansToolStripMenuItem"
        ViewActiveLoansToolStripMenuItem.Size = New Size(234, 22)
        ViewActiveLoansToolStripMenuItem.Text = "View Active Loans"
        ' 
        ' LoanRepaymentHistoryToolStripMenuItem
        ' 
        LoanRepaymentHistoryToolStripMenuItem.Name = "LoanRepaymentHistoryToolStripMenuItem"
        ...
        Text = "Ottomaxx Salon and Barbershop"
    ...
    Friend WithEvents LoansSavingsToolStripMenuItem As ToolStripMenuItem
    ...
    Friend WithEvents StaffLunchToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ReportsToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ViewStaffSalesToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ViewStaffCommissionsToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ViewStaffLoansToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ViewStaffSavingsToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents AddStaffToolStripMenuItem1 As ToolStripMenuItem
    Friend WithEvents EditStaffDetailsToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents DeleteStaffToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents RecordAttendanceToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ViewAttendanceRecordToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ViewLunchExpensesToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents RecordLunchExpensesToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ViewAllStaffToolStripMenuItem As ToolStripMenuItem
    ...
    Friend WithEvents RecordSallToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ViewSalesHistoryToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents LoansToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents RequestLoanToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents RepayLoanToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ViewActiveLoansToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents LoanRepaymentHistoryToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents SavingsToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents AddSavingsToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents WithdrawSavingsToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ViewSavingsToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents TopPerformingStaffToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ViewPaymentsToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents CashboxToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents UpdateCashboxToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ViewCashboxHistoryToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ServicesToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents StaffRolesToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ShopsToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ShopItemsToolStripMenuItem As ToolStripMenuItem
    ...
    Friend WithEvents ViewAllServicesToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents AddRoleToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents EditRoleToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents DeleteRoleToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ViewAllRolesToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents AddShopToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents EditShopToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents DeleteShopToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ViewAllShopsToolStripMenuItem As ToolStripMenuItem
